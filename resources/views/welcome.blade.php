                        ...
                        <div class="col-6 col-sm-4 col-md-3 bg-light px-1">
                                <div href="javascript:void(0);">
                                    ...
                                    <img class="text-center w-100" src="{{asset($value->product_img )}}" style="width: 180px; height:270px;" />
                                        ...
                                        <div class="text-center text-danger "><button class="btn btn-outline my-1 my-sm-0 text-danger" type="submit" >
                                            <a  class=" text-danger" href="{{ route('login') }}" /> สั่งซื้อสินค้า <i class="fa fa-shopping-cart" aria-hidden="true"></i></a></button></div>
