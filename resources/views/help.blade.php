            ...
            <div class="card">
                <ul class="navbar-nav mr-auto">
                    ...
                    <li class="nav-item active">
                        ...
                        <h7 class="nav-link ml-3 text-danger">
                        1 การยื่นคำร้องขอคืนสินค้า/คืนเงิน
                            ผู้ซื้อสามารถยื่นคำร้องขอคืนสินค้าที่ซื้อ (“สินค้า”) และ/หรือคืนเงินก่อนวันหมดเขตระยะเวลา ดังที่ระบุไว้ในเงื่อนไขการให้บริการ 
                            โดยเป็นไปตามข้อกำหนดและเงื่อนไขการให้บริการ
                        ...
                        2 การยื่นคำร้องขอคืนสินค้า
                            ผู้ซื้อสามารถยื่นคำร้องขอคืนเงินและ/หรือคืนสินค้าในสถานการณ์ต่อไปนี้เท่านั้น
                                ...
                                > สินค้ามีตำหนิ ใช้การไม่ได้
                                > ผู้ขายส่งสินค้าไม่ตรงกับข้อมูลจำเพาะที่ตกลงกันไว้ 

                            ผู้ซื้อจะต้องส่งคำร้องของผู้ซื้อผ่านทา......
                            จะตรวจสอบคำร้องของผู้ซื้อแต่ละคนแบบเป็นกรณีๆ ไป </h7>
