        ...
        <ul class="navbar-nav mr-auto ">
            ...
            <li class="nav-item active">
                ...
                <h6 class="nav-link ml-3"> 3. ตรวจสอบรายการสินค้า
                    <h7 class="nav-link ml-3">** หลังจากคลิกปุ่ม “เพิ่มไปยังรถเข็น” ผู้ซื้อต้องกรอกจำนวนสินค้าที่ต้องการ หรือ ต้องเลือกรายละเอียดสินค้าเพิ่มเติม เช่น เลือกสี, ขนาด,
                ...
                <h6 class="nav-link ml-3"> 5.การชำระเงิน
                    ...
                    <h6 class="nav-link ml-5"> วิธีที่ 2. โอนเข้าบัญชีธนาคาร กรุณาอัพโหลดหลักฐานการโอน จากนั้นคลิกปุ่ม "ส่ง" </h6>
                </h6>
