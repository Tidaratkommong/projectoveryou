...
<div class="container">
    <div class="col-md-12">
        ...
        <div class="list-group" aria-label="Basic example">
            ...
            <a href="{{url('admin/index_user')}}" class="list-group-item" style="width: 12rem;">จัดการสมาชิก</a>
            <a href="#" class="list-group-item" style="width: 12rem;">จัดการประเภทสินค้า</a>
            <a href="{{url('product/index_product')}}" class="list-group-item" style="width: 12rem;">จัดการสินค้า</a>
