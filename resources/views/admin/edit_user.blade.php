    ...
    <div class="row justify-content-center">
        <div class="col-md-8">
            <div class="card">
                ...
                <div class="card-header"><h4>{{ __('แก้ไขข้อมูล') }}</h4></div>
                <div class="card-body">
                <form action="{{route('admin.update',$users->id)}}" method="post">
                     ...
                     @method('PUT')
                        ...
                        <div class="form-group row">
                            ...
                            <div class="col-md-6">
                                <textarea id="address" type="text" class="form-control  @error('address') is-invalid @enderror" name="address"  rows="3" autocomplete="address" autofocus/>{{$users['address'] }}</textarea>
                        ...
                        <div class="form-group row">
                            ...
                            <div class="col-md-6">
                                <input id="email" type="email" pattern=".+@gmail.com" class="form-control @error('email') is-invalid @enderror" name="email" value="{{$users['email'] }}" autocomplete="email">
