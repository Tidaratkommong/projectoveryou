...
class CompletedTodoConversation extends Conversation
{
    ...
    public function run()
    {
      ...
      <br> ผู้ซื้อสามารถยื่นคำร้องขอคืนสินค้าที่ซื้อ (“สินค้า”) และ/หรือคืนเงินก่อนวันหมดเขตระยะเวลา 
      <br>ดังที่ระบุไว้ในเงื่อนไขการให้บริการโดยเป็นไปตามข้อกำหนดและเงื่อนไขการให้บริการ
      <br>
